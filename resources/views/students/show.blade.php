...
@section('content')
    ...
    <details class="group mt-5 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm open:border-teal-200">
        <summary
            class="flex cursor-pointer list-none flex-col justify-between gap-3 bg-slate-50 px-5 py-4 sm:flex-row sm:items-start">
            <div>
            ...
            <div class="grid gap-4 lg:grid-cols-3">
                ...
                <div class="rounded-2xl border border-slate-200">
                    ...
                    <div class="divide-y divide-slate-100">
                        ...
                        @empty
                            <div class="px-4 py-8 text-center text-sm text-slate-500">Belum ada jadwal aktif untuk siswa
                                ini.
                            </div>
                        @endforelse
                    </div>
    ...
    <div class="mt-5 grid gap-5 lg:grid-cols-[1fr_.8fr]">
        <section class="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <div class="grid gap-4">
                ...
                @empty
                    <div class="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-10 text-center text-slate-500">
                        Tidak
